...
const VerificationError = require('jsonld-signatures/lib/VerificationError');
...
api.suites = require('jsonld-signatures/lib/suites').suites;

// expose ProofPurpose classes to enable extensions
api.purposes = require('jsonld-signatures/lib/purposes').purposes;

// expose document loader helpers
Object.assign(api, require('jsonld-signatures/lib/documentLoader'));
